...
public interface SchoolFundsRepository extends JpaRepository<SchoolFunds, String> {
    ...
    // advanced search
    Set<SchoolFunds>
    findSchoolFundsAndBuildingsByStateContainsIgnoreCaseAndCountyContainsIgnoreCaseAndSchoolNamesContainsIgnoreCaseAndBudgetYearContains
            (String state, String county, String schoolNames, String budgetYear);
